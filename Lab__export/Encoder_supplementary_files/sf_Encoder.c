 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Jan 20 20:38:14 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_Encoder
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_Encoder_Outputs_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_Encoder_Update_wrapper(pos,  xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
